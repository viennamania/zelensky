...
function FullScreenReversedConfirmationRequiredPage() {
	return (
		<div className="flex min-w-0 flex-auto flex-col items-center sm:flex-row sm:justify-center md:items-start md:justify-start">
			<Box
				className="lg:px-28 relative hidden h-full flex-auto items-center justify-center overflow-hidden p-16 md:flex"
			...
			>
				...
				<div className="relative z-10 w-full max-w-4xl">
					...
					<div className="mt-6 text-lg leading-6 tracking-tight text-gray-400">
						Good Tether is a standard for cryptocurrency payments. rich
			...
			<Paper className="ltr:border-l-1 rtl:border-r-1 w-full px-4 py-8 sm:w-auto sm:rounded-xl sm:p-12 sm:shadow-sm md:flex md:h-full md:justify-end md:rounded-none md:p-16 md:pt-24 md:shadow-none">
				<div className="max-w-80 sm:w-80 mx-auto w-full sm:mx-0">
					<img
						className="w-12"
